            ...
            <el-dropdown trigger="click">
              ...
              >
                <ul class="min-w-[150px]">
                  <li
                    class="dropdown-item"
                    @click="$emit('showEditCompanyFileFunc', file)"
                  >
                    <div
                  ...
                  <li
                    class="dropdown-item"
                    @click="$emit('showShareCompanyFileFunc', file)"
                    divided
                  >
                  ...
                  <li
                    class="dropdown-item"
                    @click="$emit('showMoveCompanyFileFunc', file)"
                    divided
                  >
                    <div class="flex justify-between w-full">
                      <MoveIcon
                  ...
                  <li
                    class="dropdown-item"
                    @click="$emit('showRemoveCompanyFileFunc', file)"
                  >
                    <div
                      class="flex justify-between w-full border-t border-gray-200"
                    >
...
export default {
  ...
  computed: {
    allFolderFiles(){
      console.log(this.FilesInFolerContent.files)
       return this.FilesInFolerContent.files.filter((file)=> file.fileAction != null)
    },
    userType() {
      return UserTypeEnum
    },
  ...
  mounted() {
    console.log('files-in-folder', this.FilesInFolerContent.files)
  },
  methods: {
