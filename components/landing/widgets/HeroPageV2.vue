      ...
      <div class="text-center sm:text-left">
        <div class="max-w-[740px] flex flex-col justify-between">
          <div class="py-lg-4 py-2">
            ...
            <div class="lg:my-12 mt-8 mb-6 font-medium text-md lg:text-2xl">
          ...
          <div class="py-lg-4 py-2 sm:hidden lg:inline-block">
            ...
            <div class="lg:mt-7 mt-4 mb-2">
              <div class="flex flex-wrap gap-2 md:gap-3 lg:gap-4 justify-center">
                <div class="rounded drop-shadow-md bg-white cursor-pointer">
                  <div class="flex flex-wrap gap-2 py-2 px-2 px-lg-3 text-sm lg:text-lg">
                    <div class="rounded-full bg-paperdazgreen-300 text-white font-medium w-5 h-5 leading-5 lg:w-6 lg:h-6 lg:leading-6 text-center">1</div>
                    <div class="text-paperdazgreen-300">Register</div>
                  </div>
                </div>
                <div class="rounded drop-shadow-md bg-white cursor-pointer">
                  <div class="flex flex-wrap gap-2 py-2 px-2 px-lg-3 text-sm lg:text-lg">
                    <div class="rounded-full bg-paperdazgreen-300 text-white font-medium w-5 h-5 leading-5 lg:w-6 lg:h-6 lg:leading-6 text-center">2</div>
                    <div class="text-paperdazgreen-300">Upload</div>
                  </div>
                </div>
                <div class="rounded drop-shadow-md bg-white cursor-pointer">
                  <div class="flex flex-wrap gap-2 py-2 px-2 px-lg-3 text-sm lg:text-lg">
                    <div class="rounded-full bg-paperdazgreen-300 text-white font-medium w-5 h-5 leading-5 lg:w-6 lg:h-6 lg:leading-6 text-center">3</div>
