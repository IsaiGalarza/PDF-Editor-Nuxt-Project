<template>
  <div class="text-field tool">
    <svg ref="tickbox" :style="style" viewBox="0 0 20 19" fill="black" xmlns="http://www.w3.org/2000/svg">
      <path svgToImage="data:image/png;base64," options="fill"
