<template>
  <div
    class="sticky z-20 h-14 py-lg-5 pt-4 pb-4 transition ease-in-out"
    :class="[
      {
        'shadow-md': scrolled,
        'bg-white': scrolled,
  ...
  >
    ...
    <nav class="container h-full flex items-center justify-between">
      ...
      >
        ...
        <!-- <div class="h-px bg-paperdazgray-300 w-full lg:hidden"></div> -->
        <nuxt-link to="/packages/?type=default" class="xs:ml-6"
          >Packages
        </nuxt-link>
        <!-- <div class="h-px bg-paperdazgray-300 w-full lg:hidden"></div> -->
          ...
          >
            <span class="flex items-center el-dropdown-link">
              ...
              >
                <img
                  :src="profilePhoto"
                  class="w-[45px] h-full profilePhoto"
                  alt=""
      ...
      >
        ...
        >
          <span class="flex items-center el-dropdown-link">
            <span
              class="border border-paperdazgreen-300 mr-2 p-0.5 overflow-hidden relative text-center"
              :class="[
                isPaidUser
                  ? 'w-[45px] h-[45px] rounded-md'
                  : 'circle-20 rounded-full',
