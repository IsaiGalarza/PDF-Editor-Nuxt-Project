<template>
  ...
  >
    <nav
      class="nav-container h-full flex items-center justify-between full-nav bg-white py-8 rounded-lg"
    >
      ...
      >
        ...
        >
          <span class="flex items-center el-dropdown-link">
            <span class="text-lg text-grey mr-2">{{userInfo.companyName}}</span>
            <span
              class="border border-paperdazgreen-300 mr-2 p-0.5 overflow-hidden relative"
              :class="[
                isPaidUser
