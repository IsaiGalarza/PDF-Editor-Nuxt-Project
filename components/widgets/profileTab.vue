<template>
  <div class="sticky z-20 h-14 py-2 px-2 transition ease-in-out" :class="{
    'shadow-md': scrolled,
    'bg-white': scrolled,
    'bg-transparent': !scrolled
  }" style="top: -0.1px">
    <nav class="nav-container h-full flex items-center justify-between full-nav bg-white py-8 rounded-lg !px-[21px]">
